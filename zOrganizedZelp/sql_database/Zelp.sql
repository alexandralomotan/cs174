...
(1, 'Pepper Lunch', 3, 2, 2, 'Japanese hot plate'),
(2, 'Five Guys', 1, 1, 1, 'American fast food burgers and fries'),
(3, 'In N Out', 1, 1, 1, 'American fast food burgers and fries'),
(4, 'Panda Express', 2, 3, 1, 'Chinese American fast food'),
(5, 'Burger King', 1, 3, 1, 'American fast food burgers and fries'),
(6, 'Sonoma Chicken Coop', 1, 3, 2, 'New American chicken restaurant'),
(7, 'Alexander''s Steak House', 1, 4, 4, 'High end steakhouse'),
(8, 'Pho House', 7, 2, 1, 'Vietnamese restaurant'),
(9, 'Los Cubanos Restaurant', 4, 3, 3, 'Cuban restaurant famous for their lichen asado. It is tender and flavorful.'),
(10, 'Habana Cuba', 4, 3, 3, 'Cuban restaurant in downtown San Jose');
